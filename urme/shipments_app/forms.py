...
from shipments_app.models import CONDITIONS, Shipments
from users.services import COLUMNS_SHIPS
...
class Pick_display_cl(forms.Form):
    columns = forms.MultipleChoiceField(
            ...
            choices=[i for i in COLUMNS_SHIPS.items() if i[0] != 'id'],
            required=False)
