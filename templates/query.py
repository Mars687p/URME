...
select_client_async = """SELECT fsrar_id FROM clients WHERE fsrar_id = $1"""
...
insert_shipment_async = """INSERT INTO shipments(num, condition, uuid, date_creation, client_id, footing) 
...
insert_product_async = """INSERT INTO products(alcocode, full_name, capacity, alcovolume, 
                    type_product, type_code, manufacturer_id, local_reference) VALUES ($1,$2, $3, $4, $5, $6, $7, $8);"""

insert_cart_products_async = """INSERT INTO cart_products(shipment_id, product_id, positions, quantity, 
                         price_for_one, form2_old, form1) VALUES ($1, $2, $3, $4, $5, $6, $7);"""
...
update_cart_product_partly_async = """UPDATE cart_products SET quantity = $1 WHERE form2_new = $2"""


#manufacture query
insert_record_manufactures = """INSERT INTO manufactures_manufactures(num, condition, uuid, date_creation, date_production, type_operation, footing) 
                     VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id;"""

insert_manufactured_pr = """INSERT INTO manufactures_manufacturedproducts(manufactures_id, product_id, positions, quantity, 
                         batch_num, alcovolume) VALUES ($1, $2, $3, $4, $5,  $6) RETURNING id;"""

insert_raw_pr = """INSERT INTO manufactures_rawformanufactured(mf_products_id, product_id, positions, quantity, 
                         form2) VALUES ($1, $2, $3, $4, $5);"""
...
update_mf_wbf_num = """UPDATE manufactures_manufactures SET fix_number = $1 WHERE date_production=$2 and num=$3;"""
...
insert_product = """INSERT INTO products(alcocode, full_name, capacity, alcovolume, 
                    type_product, type_code, manufacturer_id, local_reference) VALUES (%s, %s, %s, %s, %s, %s, %s, %s);"""
